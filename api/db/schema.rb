...
ActiveRecord::Schema[7.0].define(version: 20_260_505_000_002) do
    ...
    create_enum 'confidence_level', %w[high medium low]
    create_enum 'coverage_state', %w[not_yet initiated partial covered]
    create_enum 'end_reason', %w[manual_candidate manual_assessor all_covered time_ceiling error]
    create_enum 'fit_result', %w[match gap exceed not_assessed]
    create_enum 'generation_status', %w[pending generating complete failed]
    create_enum 'session_status', %w[pending active ended failed]
    create_enum 'speaker_type', %w[ai candidate]
    ...
    create_table 'coverage_maps', force: :cascade do |t|
        ...
        t.index %w[session_id skill_label], name: 'index_coverage_maps_on_session_id_and_skill_label', unique: true
    ...
    create_table 'fit_gap_reports', force: :cascade do |t|
        ...
        t.index %w[portfolio_id vacancy_id], name: 'index_fit_gap_reports_on_portfolio_id_and_vacancy_id',
                                             unique: true
    ...
    create_table 'sessions', force: :cascade do |t|
        ...
        t.index %w[tenant_id status], name: 'idx_sessions_tenant_status'
    end
    ...
    create_table 'transcript_turns', force: :cascade do |t|
        ...
        t.datetime 'created_at', default: -> { 'now()' }, null: false
        t.index %w[session_id turn_number], name: 'idx_transcript_session', unique: true
